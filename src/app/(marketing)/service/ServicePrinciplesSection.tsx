...
function CircleIcon({
  ...
  return (
    <div className="w-[190px] h-[190px] rounded-full border border-primary/30 bg-white flex items-center justify-center">
      <div className="w-[140px] h-[140px] rounded-full border border-primary/15 bg-white flex items-center justify-center">
        {children}
      </div>
    </div>
  );
...
function SimpleIcon({ name }: { name: 'headphones' | 'avatar' | 'key' | 'dna' }) {
  const common = 'w-[42px] h-[42px] text-primary';
  switch (name) {
    case 'headphones':
      return (
  ...
  return (
    <section className="bg-white w-full">
      <div className="w-full max-w-[1163px] mx-auto px-4 py-[90px]">
        <h2 className="m-0 font-sans text-[28px] md:text-[32px] font-semibold leading-normal text-center text-main">
