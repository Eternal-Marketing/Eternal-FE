...
export default function ServiceIntroSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-white min-h-0 py-10 sm:py-14 md:py-16 lg:min-h-[571px] lg:py-[80px] px-4 sm:px-6 flex items-center"
    >
      <div className={`max-w-[1163px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-10 sm:gap-12 lg:gap-24 ${visible ? 'service-intro-animate' : ''}`}>
        ...
        <div className="flex-1 w-full">
          <h2 className="font-sans text-[20px] sm:text-[24px] md:text-[32px] font-bold leading-tight text-main mb-4 sm:mb-6 space-y-2">
          ...
          <div className="font-sans text-[14px] sm:text-[16px] md:text-[20px] font-light leading-relaxed md:leading-[28px] text-main space-y-1">
        ...
        <div className="flex-shrink-0 service-intro-icon">
          <img
            ...
            alt=""
            className="w-[140px] sm:w-[180px] md:w-[260px] h-auto"
          />
        </div>
      </div>
    </section>
