...
export default function ServiceCTABanner() {
  ...
  return (
    <section
      ref={sectionRef}
      className={`relative overflow-hidden py-8 sm:py-10 px-4 sm:px-6 bg-white ${visible ? 'cta-banner-spread is-visible' : 'cta-banner-spread'}`}
    >
      ...
      <div className="cta-banner-content relative z-10 max-w-[1163px] mx-auto flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-4 sm:gap-6 lg:gap-4 lg:ml-0 lg:mr-0">
        <div className="font-sans text-[15px] sm:text-[16px] lg:text-[20px] font-medium leading-relaxed text-white text-center lg:text-left lg:ml-24">
          <p>복잡한 마케팅은 맡겨주세요</p>
        ...
        <img
          ...
          alt=""
            className="w-[140px] sm:w-[180px] h-auto lg:mr-24"
        />
      </div>
    </section>
  );
