  ...
  return (
    <section ref={sectionRef} className="bg-white w-full">
      <div className="w-full max-w-[1163px] mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-[90px]">
        <h2 className="m-0 font-sans text-[22px] sm:text-[26px] md:text-[32px] font-semibold leading-normal text-center text-primary">
          PERFORMANCE MARKETING
        </h2>

        {/* RWD | SEO 라벨 */}
        <div className="mt-4 sm:mt-6 md:mt-8 text-center font-sans text-[13px] sm:text-[14px] md:text-[16px] text-sub1">
        ...
        {/* 2열 카드: 모바일부터 나란히 2열 */}
        <div
          className={`mt-8 sm:mt-10 md:mt-12 grid grid-cols-2 lg:grid-cols-2 gap-3 sm:gap-6 ${visible ? 'service-category-cards-visible' : ''}`}
        >
          <div className="service-category-card flex flex-col items-center group">
            <div className="service-category-card-inner relative w-full min-h-[220px] sm:min-h-[260px] md:h-[293px] flex items-center justify-center overflow-hidden rounded-xl sm:rounded-2xl">
              <img
