  ...
  return (
    ...
    >
      ...
      <div className="cta-banner-content relative z-10 w-full max-w-[1163px] mx-auto text-center text-white">
        <p className="m-0 font-sans text-[13px] sm:text-[15px] lg:text-[16px] font-light leading-loose">
        ...
        <p className="m-0 mt-4 sm:mt-6 font-sans text-[20px] sm:text-[24px] lg:text-[28px] font-semibold">
