...
export default function ServiceIntelligenceSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className={`relative overflow-hidden py-10 sm:py-14 lg:py-[70px] px-4 sm:px-6 bg-white ${visible ? 'cta-banner-spread is-visible' : 'cta-banner-spread'}`}
    >
      ...
      <div className="cta-banner-content relative z-10 w-full max-w-[1163px] mx-auto text-center text-white">
        <p className="m-0 font-sans text-[14px] sm:text-[15px] font-light leading-relaxed">
        ...
        <p className="m-0 mt-4 sm:mt-6 font-sans text-[16px] sm:text-[18px] font-semibold">
