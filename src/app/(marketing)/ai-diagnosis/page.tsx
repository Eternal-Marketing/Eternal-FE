...
export default function DiagnosisPage() {
  return (
    <main className="min-h-screen bg-bg text-main break-keep whitespace-normal">
      ...
      <section className="w-full max-w-[1163px] mx-auto px-4 sm:px-6 md:px-8 pt-8 sm:pt-12 md:pt-16 lg:pt-[80px] pb-12 sm:pb-16 md:pb-20 lg:pb-[110px]">
        <h2 className="m-0 font-sans text-[16px] sm:text-[18px] md:text-[20px] font-semibold leading-normal text-main">1. 고객님에 대해 알려주세요!</h2>
