...
export default function AiDiagnosisStep2Page() {
  return (
    <main className="min-h-screen bg-bg text-main break-keep whitespace-normal">
      ...
      <section className="w-full max-w-[1163px] mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-[86px] pb-12 sm:pb-16 lg:pb-[120px]">
        <h2 className="m-0 font-sans text-[16px] sm:text-[18px] font-semibold leading-normal text-main">2. 기본 정보</h2>
