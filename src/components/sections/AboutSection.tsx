  ...
  return (
    <section id="about" className="bg-[#fdfeff] overflow-hidden relative z-30 rounded-t-2xl sm:rounded-t-3xl lg:rounded-t-[80px]" data-node-id="127:907">
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10 desktop:px-[60px] pt-10 sm:pt-14 lg:pt-[100px] desktop:pt-[120px] pb-10 sm:pb-14 lg:pb-[100px] desktop:pb-[120px]">
        ...
        <FadeIn delay={200}>
          <div className="text-center mb-8 sm:mb-12 lg:mb-[100px] desktop:mb-[120px]" data-node-id="127:909">
        ...
        <div className="relative mb-8 sm:mb-12 lg:mb-20 desktop:mb-[100px]">
          <FadeIn delay={300}>
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center lg:-ml-8">
              ...
              <div className="text-center lg:text-left mt-6 sm:mt-8 lg:mt-0 lg:ml-6" data-node-id="58:95">
                ...
                <p className="font-sans text-[14px] sm:text-[16px] lg:text-[24px] font-bold text-main">
                  데이터 결과 기반
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center gap-6 sm:gap-8 lg:gap-8 lg:ml-12">
            ...
            <SlideIn direction="right" delay={600} className="flex-shrink-0">
              <div className="flex flex-col items-center" data-node-id="158:25">
                ...
                <p className="font-sans text-[12px] sm:text-[14px] font-bold text-sub1 text-center mt-3 sm:mt-4" data-node-id="127:912">
                  업종별 최상위 전문 마케터
                </p>
              </div>
            </SlideIn>
            ...
            <SlideIn direction="left" delay={700} className="flex-shrink-0">
              <div className="flex flex-col items-center" data-node-id="127:918">
                <div className="w-[240px] h-[210px] sm:w-[300px] sm:h-[260px] lg:w-[460px] lg:h-[400px] relative">
                  ...
                  <p className="absolute bottom-16 left-1/2 -translate-x-1/2 font-sans text-[12px] sm:text-[14px] font-bold text-sub1 text-center w-full" data-node-id="127:936">
                    업종별 전문 인력으로 전담 팀 구성
                  </p>
                </div>
              </div>
